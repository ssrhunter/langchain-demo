...
# look for all the env variables and load them
...
def main():
    ...
    wiki_information = """
    Elon Reeve Musk (/ˈiːlɒn/ EE-lon; born June 28, 1971) is a businessman and entrepreneur known for his leadership of Tesla, SpaceX, Twitter, and xAI. Musk has been the wealthiest person in the world since 2021; as of October 2025, Forbes estimates his net worth to be around half a trillion $USD.
    ...
    summary_template = """
    given the information {wiki_information} about a person, I want you to create:
    1. A short summary
    2. two interesting facts about them
    """

    summary_prompt_template = PromptTemplate(
        input_variables=["wiki_information"],
    ...
    response = chain.invoke(input={"wiki_information": wiki_information})
